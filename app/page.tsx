      ...
      <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-10 px-6 py-16 lg:flex-row lg:items-stretch">
        <section className="flex flex-1 flex-col justify-between gap-12">
          <div className="space-y-6">
            <p className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/80 px-4 py-1 text-xs uppercase tracking-[0.2em] text-slate-400">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="border-slate-700 bg-transparent text-slate-200 hover:bg-slate-900">
        ...
        <aside className="w-full max-w-xl rounded-3xl border border-slate-800 bg-slate-900/60 p-8 shadow-[0_30px_120px_-50px_rgba(15,23,42,0.9)] backdrop-blur">
          <div className="space-y-6">
            <h2 className="text-xl font-semibold text-slate-100">Espace secondaire</h2>
            ...
            <div className="space-y-4 rounded-2xl border border-slate-800 bg-slate-950/40 p-5">
              <h3 className="text-sm font-medium text-slate-200">Prochaines étapes</h3>
            ...
            <div className="rounded-2xl border border-slate-800 bg-gradient-to-r from-slate-900 to-slate-800 p-5">
              <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Bon à savoir</p>
